...
const LoginPage = ()=>{
    ...
    const handleLogin = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post('http://localhost:8080/login', {
                username,
                password
            }, {
                headers: {
            ...
            // Save the authentication token (if returned)
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1ef570._.js.map