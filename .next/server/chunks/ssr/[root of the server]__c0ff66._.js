...
const LoginPage = ()=>{
    ...
    async function handleLogin({ username, password }) {
        try {
            const response = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$api_URL$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["API_URL"] + 'users/login', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    "X-Requested-With": "XMLHttpRequest",
                    'Authorization': 'Basic ' + btoa('gulshan22aeccse@gmail.com:1234')
                }
            });
...
//           />
//           <input type="password" placeholder="Password" className="w-full p-2 border border-gray-300 rounded-lg" value={password} onChange={(e) => setPassword(e.target.value)}  />
//         </div>
//         <button
//           onClick={handleLogin}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c0ff66._.js.map