    ...
    async function handleLogin({ username, password }) {
        try {
            ...
            if (response.request.status == 200) {
                ...
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Features$2f$auth$2f$authSlice$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["login"])(response.data.username));
                setTimeout(()=>{}, 2000);
            }
        } catch (err) {
            console.log(err);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7a693a._.js.map