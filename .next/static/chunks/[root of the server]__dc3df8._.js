(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__dc3df8._.js", {
...
_s(SeerTechLogo, "ocZTZ8m72GkfgAfkTHk7sW+OJyw=", false, function() {
    return [
...
const fetchCandidateResume = async (candidateId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$api_URL$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_URL"]}contacts/resume/${candidateId}`, {
            method: "GET",
            headers: {
...
function Candidates() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Candidates.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$candidates$2f$candidates$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["fetchCandidates"])(currentPage - 1, 10).then({
    ...
    const handleSearch = ()=>{
        if (!searchKeyword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error("Please Enter a Keyword", {
                position: "top-center"
            });
        }
...
_s(Candidates, "zWvZBxIEytr5Tsm6DDxeCcjQkwE=");
_c = Candidates;
var _c;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dc3df8._.js.map