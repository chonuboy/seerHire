...
const LoginPage = ()=>{
    ...
    const handleLogin = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:8080/login', {
                username,
                password
            }, {
                headers: {
...
_s(LoginPage, "9pepSgSuQxhiD2kHIT57dc6EVpo=");
_c = LoginPage;
