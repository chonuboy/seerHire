(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__97fe25._.js", {
...
const Table = ({ columns, data, getRowLink, currentPage, totalPages, onPageChange, pageSize, isPaginated })=>{
    ...
    const handleDeleteClient = (id)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$master$2f$clients$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["deleteClient"])(id).then((data)=>{
            console.log(data);
            router.push("/clients");
        });
    };
                ...
                children: [
                    ...
                    data.map((item, index)=>{
                        ...
                        const rowLink = getRowLink ? getRowLink(item, index, "edit") // Pass 'edit' for edit mode
                         : null;
                        // If a link generator is provided, wrap the row in a Link component
                        return rowLink ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$link$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                            href: rowLink,
                            children: rowContent
                        }, index, false, {
                            fileName: "[project]/src/components/Elements/tables/table.tsx",
...
_s(Table, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
"[project]/src/components/Elements/tables/clientTable.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var _c;
__turbopack_refresh__.register(_c, "ClientTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/src/pages/clients/index.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Elements$2f$tables$2f$clientTable$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/Elements/tables/clientTable.tsx [client] (ecmascript)");
...
function Clients() {
    _s();
    const [allClients, setClients] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])();
    const [isClientAdded, setIsClientAdded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Form Fields
    const [clientName, setClientName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [clientHo, setClientHo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [financePocName, setFinancePocName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [financeNumber, setFinanceNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [financeEmail, setFinanceEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [gstnumber, setGstNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [cinnumber, setCinNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [pannumber, setPanNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Clients.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$master$2f$clients$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["fetchAllClients"])(currentPage - 1, 10).then({
                "Clients.useEffect": (data)=>{
                    setClients(data);
                    console.log(data);
                }
            }["Clients.useEffect"]);
    ...
    const handleAddClient = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$master$2f$clients$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["createClient"])({
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error(data, {
                    position: "top-right"
                });
                if (data.status === "success") {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].success(data.message, {
                        position: "top-right"
                    });
                    setTimeout(async ()=>{
                        const updatedClients = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$master$2f$clients$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["fetchAllClients"])();
                        setClients(updatedClients);
                    }, 1000);
                } else {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error(data.message, {
                        position: "top-right"
                    });
                }
            }).catch((err)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error(err, {
                    position: "top-right"
                });
            });
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    isClientAdded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Elements$2f$cards$2f$popup$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["Popup"], {
            ...
            allClients ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Elements$2f$tables$2f$clientTable$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                clientTableData: allClients,
                clientTableColumns: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$client$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["ClientTableColumn"],
...
_s(Clients, "pYnZ8OnBI1hwn6WriAGGausajmU=");
_c = Clients;
var _c;
__turbopack_refresh__.register(_c, "Clients");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/clients/index.tsx [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {
...
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_require__("[project]/src/pages/clients/index.tsx [client] (ecmascript)");
    }
]);
...
"[project]/src/pages/clients/index.tsx (hmr-entry)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, m: module, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_require__("[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/clients/index.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__97fe25._.js.map