(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__4e68d3._.js", {
...
const updateCandidate = async (reqData, candidateId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].put(`${apiurl}contacts/${candidateId}`, reqData, {
            headers: {
                'Content-Type': 'application/json',
                'X-Requested-With': 'XMLHttpRequest'
            }
...
const fetchCandidates = async ()=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${apiurl}contacts`);
        return response.data; // Axios automatically parses the JSON response
    } catch (err) {
        // Axios throws an error for non-2xx status codes, you can access `err.response`
        return err.response ? err.response.data : err.message;
...
const deleteCandidates = async (candidateId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete(`${apiurl}contacts/${candidateId}`);
        return response.data; // Axios automatically parses the JSON response
    } catch (err) {
        // Axios throws an error for non-2xx status codes, you can access `err.response`
        return err.response ? err.response.data : err.message;
...
const fetchCandidate = async (candidateId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${apiurl}contacts/${candidateId}`);
        return response.data; // Axios automatically parses the JSON response
    } catch (err) {
        // Axios throws an error for non-2xx status codes, you can access `err.response`
        return err.response ? err.response.data : err.message;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4e68d3._.js.map