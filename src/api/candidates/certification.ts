...
export const updateContactCertification = async (contactCertificationId: string, reqData: any) => {
  try {
...
export const deleteContactCertification = async (contactCertificationId: number) => {
  try {
