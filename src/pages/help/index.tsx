  ...
  return (
    <MainLayout>
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-5xl h-screen bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          <div className="grid md:grid-cols-5">
            {/* Left sidebar - Contact Info */}
            <div className="md:col-span-2 h-screen bg-gradient-to-br from-blue-500 to-purple-700 text-white p-8">
            ...
            <div className="md:col-span-3 p-8">
              ...
              {activeTab === "message" ? (
                ...
                <div className="h-full flex flex-col">
                  <div className="bg-gray-100 dark:bg-gray-900 rounded-xl p-4 h-64 flex items-center justify-center mb-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="mt-3 text-gray-600 dark:text-gray-400 text-sm">
                      <p>
                        Our office is located in Velachery
                      </p>
                    </div>
                  </div>
                </div>
